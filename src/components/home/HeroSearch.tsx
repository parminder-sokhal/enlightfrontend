...
const HeroSearch = () => {
  const [activeTab, setActiveTab] = useState<'projects' | 'sale' | 'rent'>('projects');
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center text-white">
        ...
        {/* Search Bar */}
        <div className="bg-white rounded-b-lg shadow-lg p-6 flex flex-col md:flex-row gap-4 mt-0">
          <input
            type="text"
            placeholder="Enter keyword..."
            className="flex-1 px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-600 focus:outline-none"
          />
          <input
            type="text"
