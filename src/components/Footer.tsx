    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-white text-xl font-bold mb-4">Flex Home</h3>
            <p className="text-gray-400 mb-4">
              Your trusted partner in finding the perfect property. We make dreams come true.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="hover:text-blue-600 transition">Our Team</a>
              </li>
              <li>
          ...
          <div>
            <h4 className="text-white text-lg font-semibold mb-4">More Information</h4>
            <ul className="space-y-2">
              <li>
                <a href="#" className="hover:text-blue-600 transition">All Projects</a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 Flex Home. All rights reserved.
            </p>
